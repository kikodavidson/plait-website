  ...
  return (
    <section className="py-24 px-6 bg-white border-t border-gray-100">
      <div className="max-w-6xl mx-auto">
        <div className="mb-14">
          <p className="text-xs font-semibold text-[#4F46E5] uppercase tracking-widest mb-3">Packages</p>
          <h2 className="font-display text-5xl sm:text-6xl font-extrabold text-[#0A0A0A] tracking-tight leading-tight">
            Pick your entry point.
          </h2>
          <p className="text-[#525252] mt-4 max-w-md text-base">
          ...
          {packages.map((pkg, i) => (
            ...
            >
              <div className="mb-6">
                ...
                <p className={`font-display text-4xl font-extrabold tracking-tight mb-3 ${pkg.highlight ? "text-white" : "text-[#0A0A0A]"}`}>
                  {pkg.price}
                </p>
