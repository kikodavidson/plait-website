...
export default function AccessNotSetUp() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-black px-6">
      <div className="max-w-md text-center bg-[#141416] rounded-2xl border border-white/10 p-10">
        <div className="w-12 h-12 mx-auto mb-5 rounded-full bg-amber-500/10 flex items-center justify-center">
          <ShieldAlert className="w-6 h-6 text-amber-500" />
        </div>
        <h1 className="text-xl font-bold text-white mb-3">Your access isn't set up yet</h1>
