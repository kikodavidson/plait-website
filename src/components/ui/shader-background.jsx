...
// ShaderBackground — "Silk" shader (21st.dev). Zero dependencies: one WebGL
// canvas that fills its parent. Pass cursorEnabled={false} to skip the global
// pointer/scroll listeners (use this for many small instances, e.g. cards).
