      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <h2
              className="text-4xl sm:text-5xl font-bold text-black leading-[1.1] tracking-tight mb-6"
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 bg-[#f4f2ee]/90 backdrop-blur-sm rounded-xl px-4 py-2 flex items-center gap-2 shadow-md">
              ...
              <span className="text-xs font-bold text-black">PLAIT Studio</span>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {pillars.map((p, i) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-black mb-3" style={{ fontFamily: 'Mavora Sans, sans-serif', letterSpacing: '0.02em' }}>{p.title}</h3>
              <p className="text-black text-sm leading-relaxed">{p.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
