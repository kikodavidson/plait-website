        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <h1 className="font-body text-4xl sm:text-5xl font-bold text-[#0A0A0A] tracking-tight leading-tight mb-8" style={{ fontFamily: 'Space Grotesk, sans-serif', letterSpacing: '0.02em' }}>{s.headline}</h1>
              {s.sections ? (
                <div className="space-y-8">
                  {s.sections.map((sec) => (
                    <div key={sec.title}>
                      <h2 className="font-body text-xl font-bold text-[#0A0A0A] mb-2">{sec.title}</h2>
                ...
                <div className="space-y-6">
                  {s.results.map((r) => (
                    <div key={r.label} className="border-b border-blue-100 pb-5 last:border-0 last:pb-0">
                      <p className="font-body text-4xl font-bold text-[#3b82f6]">{r.stat}</p>
      ...
      <div className="hero-gradient pb-16 px-6 pt-12">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="font-body text-6xl sm:text-7xl font-bold text-[#0A0A0A] tracking-tight leading-tight mb-6" style={{ fontFamily: 'Space Grotesk, sans-serif', letterSpacing: '0.02em' }}>
            ...
            >
              ...
              <div className="p-7">
                <div className="flex items-baseline gap-2 mb-3">
                  <span className="font-body text-4xl font-bold text-[#3b82f6]">{s.stat}</span>
                  <span className="text-xs font-bold text-[#525252] uppercase tracking-wider">{s.statLabel}</span>
                </div>
                <h3 className="font-body text-xl font-bold text-[#0A0A0A] mb-2 leading-tight">{s.client}</h3>
