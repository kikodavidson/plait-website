    ...
    <section className="hero-gradient min-h-[92vh] flex flex-col items-center justify-center text-center px-6 pt-40 sm:pt-48 pb-20 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto flex flex-col items-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 bg-[#2d2d2d] text-white text-xs font-semibold px-4 py-2 rounded-full mt-6 mb-10 shadow-sm"
        >
        ...
        <div className="relative">
          ...
          <div           className="text-[clamp(1.8rem,5vw,4rem)] font-bold text-[#2d2d2d] leading-[1.15] tracking-tight mb-8 h-[1.4em] flex items-center justify-center overflow-visible font-body" style={{ fontFamily: 'Space Grotesk, sans-serif', letterSpacing: '-0.02em' }}>
