...
const settingSelect =
  "w-full text-xs rounded border border-white/10 bg-[#141416] text-white px-2 py-1 focus:outline-none focus:ring-1 focus:ring-white/30";
    ...
    <div ref={innerRef} {...draggableProps} className="bg-white/5 rounded-xl border border-white/10 p-3">
      <div className="flex items-center gap-2 mb-2">
        ...
        <input
          ...
          placeholder="Qty"
        />
        <button onClick={() => api.deleteBlock(block.id)} className="ml-auto text-white/40 hover:text-red-400" title="Delete block">
      ...
      <textarea
        ...
        className="mt-2 w-full text-sm text-white/70 bg-white/5 rounded border border-white/10 placeholder:text-white/30 px-2 py-1 focus:outline-none focus:ring-1 focus:ring-white/30"
      />
