...
// WavesShaderBackground — generated by the 21st.dev Shader Builder ("Waves").
// Zero dependencies: one WebGL canvas that fills its parent.
// Palette tuned to a dark halftone fire look: black -> burnt orange -> deep
// orange-red -> pale yellow-orange highlights.
...
// Palette from the reference image: black -> #702008 -> #D9480F -> #FDB863
const UNIFORMS = {
  colors: [
    [0.0, 0.0, 0.0],
    [0.439, 0.125, 0.031],
...
export function WavesShaderBackground({ className }) {
