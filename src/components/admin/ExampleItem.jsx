...
export default function ExampleItem({ example, api, innerRef, draggableProps, dragHandleProps }) {
  return (
    <div ref={innerRef} {...draggableProps} className="w-[260px] shrink-0 flex items-start gap-2 p-2 rounded-lg hover:bg-white/[0.03] transition-colors">
      ...
      <button onClick={() => api.deleteExample(example.id)} className="text-white/40 hover:text-red-400 mt-1">
