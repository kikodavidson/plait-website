  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "pointer-events-none block h-full w-full transition-all duration-300 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,1.275)]",
            ...
            {shouldRenderIcons && (
              <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
                ...
                <div className={cn(
                  ...
                  {checkedIcon ? checkedIcon : <Check className={iconClasses} strokeWidth={4} />}
                </div>
                ...
                <div className={cn(
                  ...
                  {uncheckedIcon ? uncheckedIcon : <X className={iconClasses} strokeWidth={4} />}
                </div>
              </div>
            )}
          </div>
