    ...
    <section className="hero-gradient min-h-[92vh] flex flex-col items-center justify-center text-center px-6 pt-40 sm:pt-48 pb-20 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="relative">
          ...
          <div           className="text-[clamp(1.8rem,5vw,4rem)] font-extrabold text-[#0A0A0A] leading-[1.15] tracking-tight mb-8 h-[1.4em] flex items-center justify-center overflow-visible font-body" style={{ fontFamily: 'Montserrat, sans-serif', letterSpacing: '0.02em' }}>
